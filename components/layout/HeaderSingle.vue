    ...
    <div class="header-top">
      <div class="inner-container">
        <div class="top-left">
          ...
          <ul class="list-style-one">
            <li><i class="fa fa-envelope"></i> <NuxtLink to="/mailto:needhelp@company.com">needhelp@company.com</NuxtLink>
            </li>
      ...
      <div class="outer-box">
        <ul class="social-icon-one">
          ...
          <li><NuxtLink to="#"><span class="fab fa-facebook-square"></span></NuxtLink></li>
          <li><NuxtLink to="#"><span class="fab fa-pinterest-p"></span></NuxtLink></li>
      ...
      <div class="main-box">
        ...
        <div class="nav-outer">
          ...
          <div class="outer-box">
            ...
            <NuxtLink to="/page-contact" class="theme-btn btn-style-one"><span class="btn-title">get solution</span></NuxtLink>
    ...
    <div class="mobile-menu">
      ...
      <nav class="menu-box">
        <div class="upper-box">
          ...
          <div class="close-btn" @click="handleToggled"><i class="icon fa fa-times"></i>
          </div>
        </div>

        <LayoutMobileMenuSingle />
