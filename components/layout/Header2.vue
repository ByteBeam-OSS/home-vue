  ...
  <header class="main-header header-style-two" :class="{ 'moblie-search-active': isSearch }"> 
    ...
    <div class="header-lower"> 
      ...
      <div class="main-box">
        <div class="logo-box">
          <div class="logo">
            <NuxtLink to="/"><img src="/images/logo-2.png" alt="" title="Oitech"></NuxtLink>
          </div>
        </div>
        ...
        <div class="nav-outer">
          ...
          <div class="outer-box">
            <div class="ui-btn-outer">
              <button class="ui-btn ui-btn search-btn" @click="handleSearch"> <span class="icon lnr lnr-icon-search"></span> </button>
              <NuxtLink to="#" class="ui-btn"><i class="lnr-icon-shopping-cart"></i></NuxtLink>
            </div>
            <NuxtLink to="/tel:+92(8800)9806" class="info-btn"> <i class="icon fa fa-phone"></i> <small>Call Anytime</small><br>
              +92 (8800) 9806 </NuxtLink>
            <NuxtLink to="/page-contact" class="theme-btn btn-style-one"><span class="btn-title">get
              solution</span></NuxtLink>
    ...
    <div class="mobile-menu">
      ...
      <nav class="menu-box">
        ...
        <ul class="contact-list-one">
          <li> 
            <!-- Contact Info Box -->
            <div class="contact-info-box"> <i class="icon lnr-icon-phone-handset"></i> <span class="title">Call Now</span>
              <NuxtLink to="/tel:+92880098670">+92 (8800) - 98670</NuxtLink>
            </div>
          </li>
          <li> 
            <!-- Contact Info Box -->
            <div class="contact-info-box"> <span class="icon lnr-icon-envelope1"></span> <span class="title">Send Email</span>
    ...
    <div class="sticky-header" :class="{ 'fixed-header animated slideInDown': scroll }">
      <div class="auto-container">
        <div class="inner-container"> 
          <!--Logo-->
          <div class="logo">
            <NuxtLink to="/" title=""><img src="/images/logo-2.png" alt="" title=""></NuxtLink>
          </div>
