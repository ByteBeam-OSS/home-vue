<template>
    <header class="main-header header-style-five" :class="{ 'moblie-search-active': isSearch }">
        <!-- Header Lower -->
        <div class="header-lower">
            <!-- Main box -->
            <div class="main-box">
                <div class="logo-box">
                    <div class="logo"><NuxtLink to="/index"><img src="/images/logo.png" alt="" title="Oitech"></NuxtLink></div>
                </div>
