				...
				<div class="row">
					<div class="col-xl-8 col-lg-8">
						<div class="project-details__content-left">
							<h3 class="">Here to Know About This Project</h3>
							<p class="">There are many variations of passages of psum
							...
							<p class="mb-5">Eque porro est qui dolorem ipsum quia quaed inventore
							...
							<h3 class="">Organic Food Supply</h3>
							<p class="">When an unknown printer took a galley of type and
							...
							<div class="project-details__details-box">
								...
								<ul class="list-unstyled project-details__details-list">
									<li>
										...
										<h4 class="project-details__name">22 April, 2022</h4>
									</li>
									<li>
									...
									<li>
										...
										<h4 class="project-details__name">$11,367</h4>
									</li>
									<li>
										<div class="project-details__social"> <NuxtLink to="/"><i class="fab fa-twitter"></i></NuxtLink> <NuxtLink to="/"><i class="fab fa-facebook"></i></NuxtLink> <NuxtLink to="/"><i class="fab fa-pinterest-p"></i></NuxtLink> <NuxtLink to="/"><i class="fab fa-instagram"></i></NuxtLink> </div>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="col-xl-12">
					<div class="project-details__pagination-box">
						<ul class="project-details__pagination list-unstyled clearfix">
							<li class="next">
								<div class="icon"> <NuxtLink to="/" aria-label="Previous"><i class="lnr lnr-icon-arrow-left"></i></NuxtLink> </div>
								<div class="content">Previous</div>
							</li>
							<li class="count"><NuxtLink to="/"></NuxtLink></li>
							<li class="count"><NuxtLink to="/"></NuxtLink></li>
							<li class="count"><NuxtLink to="/"></NuxtLink></li>
							<li class="count"><NuxtLink to="/"></NuxtLink></li>
							<li class="previous">
								<div class="content">Next</div>
								<div class="icon"> <NuxtLink to="/" aria-label="Previous"><i class="lnr lnr-icon-arrow-right"></i></NuxtLink> </div>
							</li>
						</ul>
					</div>
				</div>
