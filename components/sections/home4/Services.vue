			...
			<div class="row">
				...
				<div class="service-block-four col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
					<div class="inner-box ">
						...
						<h5 class="title"><NuxtLink to="page-service-details">Product <br>Development</NuxtLink></h5>
				...
				<div class="service-block-four col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
					<div class="inner-box ">
						...
						<h5 class="title"><NuxtLink to="page-service-details">Digital <br>Marketing</NuxtLink></h5>
						<div class="text">Providing the solutions for tech business</div>
					</div>
				</div>
				...
				<div class="service-block-four col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
					<div class="inner-box ">
						...
						<h5 class="title"><NuxtLink to="page-service-details">Security <br>System</NuxtLink></h5>
						<div class="text">Providing the solutions for tech business</div>
					</div>
				</div>
				...
				<div class="service-block-four col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="1200ms">
					<div class="inner-box ">
						...
						<h5 class="title"><NuxtLink to="page-service-details">UI/UX <br>Designing</NuxtLink></h5>
						<div class="text">Providing the solutions for tech business</div>
					</div>
				</div>
			</div>
